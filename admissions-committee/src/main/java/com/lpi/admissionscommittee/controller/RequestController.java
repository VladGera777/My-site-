...
import com.lpi.admissionscommittee.service.EnrollmentRequestService;
...
public class RequestController {
    ...
    public String deleteRequest(@PathVariable String id,
        ...
        if (!ParamValidator.isIntegerOrLong(id)) {
            log.warn(Constants.INCORRECT_REQUEST_ID + id);
            redirectAttributes.addAttribute(Constants.ERROR, Constants.INCORRECT_REQUEST);
        } else {
        ...
        return Constants.REDIRECT_ALL_REQUESTS;
    }
    ...
    public String getStatementForm(@PathVariable String id,
        ...
        if (!ParamValidator.isIntegerOrLong(id)) {
            log.warn(Constants.INCORRECT_REQUEST_ID + id);
            model.addAttribute(Constants.ERROR, Constants.INCORRECT_REQUEST);
            return Constants.ALL_REQUESTS;
        } else {
